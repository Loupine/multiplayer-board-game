...
func _init(scene_tree: SceneTree, multiplayer_id: int, total_board_positions: int, board_positions_node: Node, controls_node: Node)->void:
	_move_action = MoveAction.new(scene_tree, multiplayer_id, total_board_positions, board_positions_node, controls_node)
